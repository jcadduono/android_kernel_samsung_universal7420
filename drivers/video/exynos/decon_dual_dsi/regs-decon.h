...
#define DISP_CFG_DECON_INT_TE_SWAP (0x01 << 3)
#define DISP_CFG_DECON_EXT_TE_SWAP (0x01 << 2)
...
#define FRAMEFIFO_FIFO_SHARE_EN			(0x1 << 0)

#define FRAMEFIFO_REG10				0x053C
#define FRAMEFIFO_WB_MODE_F			(0x1 << 26)
#define FRAMEFIFO_SPLIT_IDX_F(_v)		(((_v) & 0x1fff) << 0)
#define FRAMEFIFO_SPLIT_IDX_F_MASK		(0x1fff << 0)
