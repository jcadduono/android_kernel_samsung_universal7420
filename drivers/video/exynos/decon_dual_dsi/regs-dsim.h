...
/* CMU: DPHY_PLL_CON */
#define DPHY_PLL_CON0_LOCKED			(0x1 << 29)
#define DPHY_PLL_CON1				0x4
#define DPHY_PLL_CON1_LOCK_EN			(0x1 << 17)
...
/* DSIM1 source clock selection
 * 0: clock from DSIM0 DPHY PLL, 1: clock from externel source(DPHY PLL) */
#define DSIM_PHYCTRL_M2_SEL_HS_CLK_SRC		(0x1 << 0)
